 ...
 * EncuestaMaestria
 *
 * @ORM\Table(name="EncuestaMaestria")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\EncuestaMaestriaRepository")
 */
class EncuestaMaestria
{
    /**
     * @var integer
     *
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="anioGraduacion", type="datetimetz")
     */
    private $anioIngreso;
